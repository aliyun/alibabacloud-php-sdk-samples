...
class Sample {
   ...
   */
  static public function ratePlanInstSshfp($client)
  {
  ...
  /**
   * @param PurchaseRatePlanResponseBody $ratePlanInstSshfpResponseBody
   * @param ESA $client
   * @return CreateSiteResponseBody
   */
  static public function siteSshfp($ratePlanInstSshfpResponseBody, $client)
  {
    Console::info('Begin Call CreateSite to create resource');
    $createSiteRequest = new CreateSiteRequest([
      'siteName' => 'gositecdn.cn',
      'instanceId' => $ratePlanInstSshfpResponseBody->instanceId,
      'coverage' => 'overseas',
      'accessType' => 'NS',
    ]);
  ...
  /**
   * @param CreateSiteResponseBody $siteSshfpResponseBody
   * @param ESA $client
   * @return CreateRecordResponseBody
   */
  static public function recordSshfp($siteSshfpResponseBody, $client)
  {
    ...
    $createRecordRequest = new CreateRecordRequest([
      ...
      'siteId' => $siteSshfpResponseBody->siteId,
      'type' => 'SSHFP',
      'data' => $data,
      'ttl' => 100,
    ]);
   ...
   * @return void
   */
  static public function updateRecordSshfp($createRecordResponseBody, $client)
  {
   ...
   * @return void
   */
  static public function destroyRecordSshfp($createRecordResponseBody, $client)
  {
  ...
  static public function main($args)
  {
    ...
    // Init resource
    $ratePlanInstSshfpRespBody = self::ratePlanInstSshfp($esa20240910Client);
    $siteSshfpRespBody = self::siteSshfp($ratePlanInstSshfpRespBody, $esa20240910Client);
    $recordSshfpRespBody = self::recordSshfp($siteSshfpRespBody, $esa20240910Client);
    // update resource
    self::updateRecordSshfp($recordSshfpRespBody, $esa20240910Client);
    // destroy resource
    self::destroyRecordSshfp($recordSshfpRespBody, $esa20240910Client);
  }
