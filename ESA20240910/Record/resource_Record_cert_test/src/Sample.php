...
class Sample {
   ...
   */
  static public function ratePlanInstCert($client)
  {
  ...
  /**
   * @param PurchaseRatePlanResponseBody $ratePlanInstCertResponseBody
   * @param ESA $client
   * @return CreateSiteResponseBody
   */
  static public function siteCert($ratePlanInstCertResponseBody, $client)
  {
  ...
  /**
   * @param CreateSiteResponseBody $siteCertResponseBody
   * @param ESA $client
   * @return CreateRecordResponseBody
   */
  static public function recordCert($siteCertResponseBody, $client)
  {
   ...
   * @return void
   */
  static public function updateRecordCert($createRecordResponseBody, $client)
  {
   ...
   * @return void
   */
  static public function destroyRecordCert($createRecordResponseBody, $client)
  {
  ...
  static public function main($args)
  {
    ...
    // Init resource
    $ratePlanInstCertRespBody = self::ratePlanInstCert($esa20240910Client);
    $siteCertRespBody = self::siteCert($ratePlanInstCertRespBody, $esa20240910Client);
    $recordCertRespBody = self::recordCert($siteCertRespBody, $esa20240910Client);
    // update resource
    self::updateRecordCert($recordCertRespBody, $esa20240910Client);
    // destroy resource
    self::destroyRecordCert($recordCertRespBody, $esa20240910Client);
  }
