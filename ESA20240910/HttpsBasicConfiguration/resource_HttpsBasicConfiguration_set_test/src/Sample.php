...
class Sample {
   ...
   */
  static public function httpsCfg($siteResponseBody, $client)
  {
   ...
   * @return void
   */
  static public function updateHttpsCfg($siteResponseBody, $createHttpsBasicConfigurationResponseBody, $client)
  {
   ...
   * @return void
   */
  static public function destroyHttpsCfg($siteResponseBody, $createHttpsBasicConfigurationResponseBody, $client)
  {
  ...
  static public function main($args)
  {
    ...
    // update resource
    self::updateHttpsCfg($siteRespBody, $httpsCfgRespBody, $esa20240910Client);
    // destroy resource
    self::destroyHttpsCfg($siteRespBody, $httpsCfgRespBody, $esa20240910Client);
  }
